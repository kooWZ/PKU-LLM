...
class Generator:
    ...
    def __init__(
        self, model, tokenizer, max_new_tokens=1024, temperature=0.2, device="cuda:0"
    ):
        ...
        self.stop_str = (
            conv_llava_llama_2.sep
            if conv_llava_llama_2.sep_style != SeparatorStyle.TWO
            else conv_llava_llama_2.sep2
        )
